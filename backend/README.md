...
## Project Structure
    ...
    ├── myriad_motivations_42262  # Django project configurations
...
1. Clone this repo and `cd myriad_motivations_42262`
...
2. Clone this repo and `cd myriad_motivations_42262`
